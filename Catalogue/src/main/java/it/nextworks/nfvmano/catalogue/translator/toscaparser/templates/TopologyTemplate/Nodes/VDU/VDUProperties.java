...
package it.nextworks.nfvmano.catalogue.translator.toscaparser.templates.TopologyTemplate.Nodes.VDU;
...
public class VDUProperties {
	...
	public VDUProperties(Object vduProp) {
		...
		final Map<String, Object> vduPropMap = (Map<String, Object>) vduProp;
		...
		if (vduPropMap.containsKey("vim_instance_name")) {
			vim_instance_name = new LinkedHashSet<String>() {
				{
		 ...
		 * fault_management_policy = new
		 * VDUFaultManagement(vduPropMap.get("fault_management_policy")); }
		 */
	...
	/*
	 * public VDUFaultManagement getFault_management_policy() { return
	 * fault_management_policy; }
	 */

	/*
	 * public void setFault_management_policy(VDUFaultManagement
	 * fault_management_policy) { this.fault_management_policy =
	 * fault_management_policy; }
	 */
