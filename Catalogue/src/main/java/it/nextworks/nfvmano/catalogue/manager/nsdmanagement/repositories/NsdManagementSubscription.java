...
*/
package it.nextworks.nfvmano.catalogue.manager.nsdmanagement.repositories;

import com.fasterxml.jackson.annotation.JsonIgnore;
import it.nextworks.nfvmano.catalogue.manager.nsdmanagement.NsdManagementRestConsumer;
