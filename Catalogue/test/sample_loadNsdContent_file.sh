...
curl -X PUT -v -F file=@vCDN_tosca_v01.yaml http://localhost:8083/nsd/v1/ns_descriptors/XXXXXXX/nsd_content --header "Content-Type:text/plain" --header "Accept:application/json"
