...
public class ToscaDescriptorsParser {
    ...
    public static DescriptorTemplate generateVnfDescriptor(String osmVnfDescriptorPath) throws IOException, IllegalArgumentException {
        ...
        for(ConnectionPoint cp : osmVnfDescriptor.getConnectionPoints()){
            ...
            virtualLink.add(new VirtualLinkPair(cp.getName(), cp.getName() + "_net"));
        ...
        if(vdu.getCloudInit() != null)
            vnfInterfaces = new VNFInterfaces(null, new Vnflcm(new LcmOperation(vdu.getCloudInit()), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null));
