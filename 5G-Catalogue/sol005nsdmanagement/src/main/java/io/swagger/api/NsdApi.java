...
public interface NsdApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Status 201", response = NsdInfo.class),
        @ApiResponse(code = 500, message = "", response = ProblemDetails.class) })
    @RequestMapping(value = "/nsd/v1/ns_descriptors",
        produces = { "application/json", "application/yaml" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<NsdInfo> createNsdInfo(@ApiParam(value = "" ,required=true )  @Valid @RequestBody CreateNsdInfoRequest body);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Status 201", response = PnfdInfo.class),
        @ApiResponse(code = 400, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 500, message = "", response = ProblemDetails.class) })
    @RequestMapping(value = "/nsd/v1/pnf_descriptors",
        produces = { "application/json", "application/yaml" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<PnfdInfo> createPNFDInfo(@ApiParam(value = "" ,required=true )  @Valid @RequestBody PnfdInfo body);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Status 201", response = NsdmSubscription.class),
        ...
        @ApiResponse(code = 400, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 500, message = "", response = ProblemDetails.class) })
    @RequestMapping(value = "/nsd/v1/subscriptions",
        produces = { "application/json", "application/yaml" }, 
        method = RequestMethod.POST)
    ResponseEntity<NsdmSubscription> createSubscription(@ApiParam(value = "" ,required=true )  @Valid @RequestBody NsdmSubscriptionRequest body);
    ...
    @RequestMapping(value = "/nsd/v1/ns_descriptors/{nsdInfoId}",
        produces = { "application/json", "application/yaml" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Void> deleteNSDInfo(@ApiParam(value = "",required=true) @PathVariable("nsdInfoId") String nsdInfoId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 204, message = "The operation has completed successfully. The response body shall be empty."),
        @ApiResponse(code = 400, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 404, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 500, message = "", response = ProblemDetails.class) })
    @RequestMapping(value = "/nsd/v1/pnf_descriptors/{pnfdInfoId}",
        produces = { "application/json", "application/yaml" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Void> deletePNFDInfo(@ApiParam(value = "",required=true) @PathVariable("pnfdInfoId") String pnfdInfoId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 500, message = "", response = ProblemDetails.class) })
    @RequestMapping(value = "/nsd/v1/subscriptions/{subscriptionId}",
        produces = { "application/json", "application/yaml" }, 
        method = RequestMethod.DELETE)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 404, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 409, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 500, message = "", response = ProblemDetails.class) })
    @RequestMapping(value = "/nsd/v1/ns_descriptors/{nsdInfoId}",
        produces = { "application/json", "application/yaml" }, 
        method = RequestMethod.GET)
    ResponseEntity<NsdInfo> getNSDInfo(@ApiParam(value = "",required=true) @PathVariable("nsdInfoId") String nsdInfoId);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 500, message = "", response = ProblemDetails.class) })
    @RequestMapping(value = "/nsd/v1/pnf_descriptors/{pnfdInfoId}/pnfd_content",
        produces = { "application/json", "application/yaml", "application/zip" }, 
        method = RequestMethod.GET)
    ResponseEntity<Object> getPNFD(@ApiParam(value = "",required=true) @PathVariable("pnfdInfoId") String pnfdInfoId);
    ...
    @RequestMapping(value = "/nsd/v1/pnf_descriptors/{pnfdInfoId}",
        produces = { "application/json", "application/yaml" }, 
        method = RequestMethod.GET)
    ResponseEntity<PnfdInfo> getPNFDInfo(@ApiParam(value = "",required=true) @PathVariable("pnfdInfoId") String pnfdInfoId);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Status 200", response = NsdmSubscription.class),
        @ApiResponse(code = 400, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 404, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 500, message = "", response = ProblemDetails.class) })
    @RequestMapping(value = "/nsd/v1/subscriptions/{subscriptionId}",
        produces = { "application/json", "application/yaml" }, 
        method = RequestMethod.GET)
    ResponseEntity<NsdmSubscription> getSubscription(@ApiParam(value = "",required=true) @PathVariable("subscriptionId") String subscriptionId);
    ...
    @RequestMapping(value = "/nsd/v1/subscriptions",
        produces = { "application/json", "application/yaml" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<NsdmSubscription>> getSubscriptions();
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Status 200", response = NsdInfoModifications.class),
        @ApiResponse(code = 404, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 409, message = "Status 409", response = ProblemDetails.class),
    ...
    ResponseEntity<NsdInfoModifications> updateNSDInfo(@ApiParam(value = "",required=true) @PathVariable("nsdInfoId") String nsdInfoId,@ApiParam(value = "" ,required=true )  @Valid @RequestBody NsdInfoModifications body);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Status 200", response = PnfdInfoModifications.class),
        @ApiResponse(code = 400, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 404, message = "", response = ProblemDetails.class),
        @ApiResponse(code = 412, message = "Status 412", response = ProblemDetails.class),
        @ApiResponse(code = 500, message = "", response = ProblemDetails.class) })
    @RequestMapping(value = "/nsd/v1/pnf_descriptors/{pnfdInfoId}",
        ...
        consumes = { "application/json" },
        method = RequestMethod.PATCH)
    ResponseEntity<PnfdInfoModifications> updatePNFDInfo(@ApiParam(value = "",required=true) @PathVariable("pnfdInfoId") String pnfdInfoId,@ApiParam(value = "" ,required=true )  @Valid @RequestBody PnfdInfoModifications body);
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 202, message = "Status 202", response = Object.class),
    ...
    @RequestMapping(value = "/nsd/v1/ns_descriptors/{nsdInfoId}/nsd_content",
        produces = { "application/json", "application/yaml" }, 
        consumes = { "application/json", "application/yaml", "application/zip" },
