...
public interface NsdApi {
    ...
    ResponseEntity<?> getNSDsInfo(@RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization);
    ...
    ResponseEntity<?> updateNSDInfo(
            ...
            @ApiParam(value = "", required = true) @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization, @Valid @RequestBody NsdInfoModifications body);
    ...
    ResponseEntity<?> getNSD(@ApiParam(value = "", required = true) @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization, @PathVariable("nsdInfoId") String nsdInfoId,
    ...
    ResponseEntity<?> uploadNSD(@ApiParam(value = "", required = true) @PathVariable("nsdInfoId") String nsdInfoId,
                                @ApiParam(value = "", required = true) @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization, @RequestParam("file") MultipartFile body,
    ...
    ResponseEntity<?> createPNFDInfo(@ApiParam(value = "", required = true) @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization, @Valid @RequestBody CreatePnfdInfoRequest body);
    ...
    ResponseEntity<?> getPNFDsInfo(
            ...
            @ApiParam(value = "Include all complex attributes in the response. See clause 4.3.3 for details. The NFVO shall support this parameter.") @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization, @Valid @RequestParam(value = "all_fields", required = false) String allFields);
    ...
    ResponseEntity<?> updatePNFDInfo(
            ...
            @ApiParam(value = "", required = true) @RequestHeader(value = HttpHeaders.AUTHORIZATION, required = false) String authorization, @Valid @RequestBody PnfdInfoModifications body);
