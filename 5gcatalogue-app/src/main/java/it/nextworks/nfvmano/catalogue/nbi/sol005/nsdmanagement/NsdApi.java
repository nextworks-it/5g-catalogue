...
public interface NsdApi {
    ...
    @RequestMapping(value = "/nsd/v1/ns_descriptors", produces = {"application/json",
            "application/yaml"}, consumes = {"application/json"}, method = RequestMethod.POST)
    ResponseEntity<NsdInfo> createNsdInfo(
    ...
    @ApiResponses(value = {@ApiResponse(code = 201, message = "Status 201", response = PnfdInfo.class),
            @ApiResponse(code = 400, message = "Status 400", response = ProblemDetails.class),
            @ApiResponse(code = 500, message = "Status 500", response = ProblemDetails.class)})
    @RequestMapping(value = "/nsd/v1/pnf_descriptors", produces = {"application/json",
            "application/yaml"}, consumes = {"application/json"}, method = RequestMethod.POST)
    ...
    @ApiResponses(value = {@ApiResponse(code = 201, message = "Status 201", response = NsdmSubscription.class),
            ...
            @ApiResponse(code = 400, message = "Status 400", response = ProblemDetails.class),
            @ApiResponse(code = 500, message = "Status 500", response = ProblemDetails.class)})
    @RequestMapping(value = "/nsd/v1/subscriptions", produces = {"application/json",
            "application/yaml"}, method = RequestMethod.POST)
    ResponseEntity<NsdmSubscription> createSubscription(
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Status 404", response = ProblemDetails.class),
            @ApiResponse(code = 500, message = "Status 500", response = ProblemDetails.class)})
    @RequestMapping(value = "/nsd/v1/pnf_descriptors/{pnfdInfoId}", produces = {"application/json",
            "application/yaml"}, method = RequestMethod.DELETE)
    ResponseEntity<Void> deletePNFDInfo(
    ...
    @RequestMapping(value = "/nsd/v1/subscriptions/{subscriptionId}", produces = {"application/json",
            "application/yaml"}, method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/nsd/v1/pnf_descriptors/{pnfdInfoId}", produces = {"application/json",
            "application/yaml"}, method = RequestMethod.GET)
    ResponseEntity<PnfdInfo> getPNFDInfo(
            @ApiParam(value = "", required = true) @PathVariable("pnfdInfoId") String pnfdInfoId);
    ...
    @RequestMapping(value = "/nsd/v1/pnf_descriptors", produces = {"application/json",
            "application/yaml"}, method = RequestMethod.GET)
    ResponseEntity<List<PnfdInfo>> getPNFDsInfo(
    ...
    @RequestMapping(value = "/nsd/v1/subscriptions/{subscriptionId}", produces = {"application/json",
            "application/yaml"}, method = RequestMethod.GET)
    ResponseEntity<NsdmSubscription> getSubscription(
            @ApiParam(value = "", required = true) @PathVariable("subscriptionId") String subscriptionId);
    ...
    @RequestMapping(value = "/nsd/v1/pnf_descriptors/{pnfdInfoId}", produces = {"application/json",
            "application/yaml"}, consumes = {"application/json"}, method = RequestMethod.PATCH)
    ResponseEntity<PnfdInfoModifications> updatePNFDInfo(
            @ApiParam(value = "", required = true) @PathVariable("pnfdInfoId") String pnfdInfoId,
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 500, message = "Status 500", response = ProblemDetails.class)})
    @RequestMapping(value = "/nsd/v1/pnf_descriptors/{pnfdInfoId}/pnfd_content", produces = {"application/json",
            "application/yaml"}, consumes = {"application/json", "application/yaml"}, method = RequestMethod.PUT)
